...
public interface RaceDao extends RaceOrganiserDao {
    ...
    /**
     * @param race
     *            The {@link Race} object containing the control id, round
    ...
    /**
     * @param controlId
     *            The control id for the set of races needed
     * @param division
     *            The division of races, use {@code null} for all divisions
     * @param roundNo
     *            The round number, 3 for knockouts, 0 for all rounds
    ...
    /**
     * @param race
     *            The {@link Race} object containing the control id, division,
