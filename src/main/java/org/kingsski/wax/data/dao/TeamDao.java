...
public interface TeamDao extends RaceOrganiserDao {
     ...
     *
     * @param team The Team object containing the details of team being searched
     *             for
     ...
     *
     * @param division       the division which is competing
     * @param competingClubs the list of {@link Club}s which are competing
     * @param league         the league which we are retrieving teams for
     ...
     *
     * @param club     The {@link Club} to optionally filter on
     * @param division The division to optionally filter on
     * @param league   The league to filter on
    ...
    /**
     * @param club the {@link Club} for which all teams should be deleted
     */
     ...
     * @param add  If set to true and the team does not already exist then it
     *             will be added
    ...
    /**
     * @param league   the league for which {@link Team}s should have their scores
     *                 reset
     * @param division the division under which the {@link Team}s should have their
     *                 scores reset
     */
