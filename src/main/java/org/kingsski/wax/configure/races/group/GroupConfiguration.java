...
public class GroupConfiguration {
     ...
     * The constructor
     *
     * @param value    the value associated with this configuration. The first digit
     *                 must be the number of teams in this group
     * @param raceGrid the multi-dimensional integer array defining the races
     ...
     * </p>
     *
     * @param controlId the control ID associated with these races
     * @param roundNo   the round number associated with these races
     * @param group     the name of the group that these races are identified by
     * @param teams     the list of {@link Team}s which will be competing in the races
